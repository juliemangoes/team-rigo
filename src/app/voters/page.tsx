...
export default function VotersPage() {
  ...
  function getPickupStatusLabel(value: string | null) {
    if (!value || value === "No Pickup Needed" || value === "Not Needed") {
      return "Not Needed";
    }
                    ...
                    <tr key={voter.id} className="align-top">
                      ...
                      <td className="px-3 py-3">
                        ...
                        <p className="mt-2 text-xs text-slate-500">
                          {voter.pickup_needed ? getPickupStatusLabel(voter.pickup_status || "Not Contacted") : ""}
                        </p>
                      </td>
